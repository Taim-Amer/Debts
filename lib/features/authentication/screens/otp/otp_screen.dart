        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(width : THelperFunctions.screenWidth(context), child: OtpTextFieldWidget(controller: OtpController.instance.codeController)),
              TSizes.spaceBtwSections.verticalSpace,
              Obx(() {
                Widget current = OtpController.instance.otpApiStatus.value == RequestState.loading ? const LoadingWidget() : const OtpNextButton();
                return current;
              }),
              TSizes.spaceBtwSections.verticalSpace,
