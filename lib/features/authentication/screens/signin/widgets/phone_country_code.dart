...
class _CustomPhoneCountryCodeState extends State<PhoneCountryCode> {
  ...
  final List<Country> countries = [
    Country(code: '+966', title: 'السعودية', svg: TImages.saudi),
    Country(code: '+974', title: 'قطر', svg: TImages.qatar),
    Country(code: '+20', title: 'مصر', svg: TImages.egypt),
    Country(code: '+961', title: 'لبنان', svg: TImages.lebanon),
  ];
