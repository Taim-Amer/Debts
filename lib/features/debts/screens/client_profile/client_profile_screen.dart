...
class ClientProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // appBar: TAppBar(title: ClientProfileAppbar(),),
      floatingActionButton: FloatingActionButton(onPressed: (){}),
      floatingActionButtonLocation: FloatingActionButtonLocation.endTop,
      bottomNavigationBar: Obx(() {
        return ClientProfileController.instance.getClientProfileStatus.value != RequestState.success ? const Center(child: LoadingWidget()) : const ClientProfileNavBar();
      }),
      body: Obx(() {
        return ClientProfileController.instance.getClientProfileStatus.value == RequestState.loading ? const Center(child: LoadingWidget()) : SingleChildScrollView(
          child: Padding(
